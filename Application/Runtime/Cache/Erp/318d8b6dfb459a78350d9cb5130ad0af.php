...
<script language="javascript" type="text/javascript" src="/merp/Public/jqplot/jquery.jqplot.min.js"></script> 
<script language="javascript" type="text/javascript" src="/merp/Public/jqplot/plugins/jqplot.canvasTextRenderer.min.js"></script> 
<script language="javascript" type="text/javascript" src="/merp/Public/jqplot/plugins/jqplot.canvasAxisLabelRenderer.min.js"></script> 
<script language="javascript" type="text/javascript" src="/merp/Public/jqplot/plugins/jqplot.categoryAxisRenderer.min.js"></script> 
<script language="javascript" type="text/javascript" src="/merp/Public/jqplot/plugins/jqplot.pointLabels.min.js"></script> 
<script language="javascript" type="text/javascript" src="/merp/Public/jqplot/plugins/jqplot.pieRenderer.min.js"></script> 
<script language="javascript" type="text/javascript" src="/merp/Public/jqplot/plugins/jqplot.donutRenderer.min.js"></script> 
<script language="javascript" type="text/javascript" src="/merp/Public/jqplot/plugins/jqplot.barRenderer.min.js"></script> 
<script language="javascript" type="text/javascript" src="/merp/Public/jqplot/plugins/jqplot.dateAxisRenderer.min.js"></script> 
<script language="javascript" type="text/javascript" src="/merp/Public/jqplot/plugins/jqplot.highlighter.min.js"></script> 
<link rel="stylesheet" type="text/css" href="/merp/Public/jqplot/jquery.jqplot.min.css" /> 
<script type="text/javascript">
$(function () {
...
<form action="<?php echo U('Statistics/purchase',array('op'=>$op));?>" name="form" method="post" >
        ...
        <div class="col-sm-12">
          <div class="panel panel-primary">
            <div class="panel-heading">
              <h4 class="panel-title">采购数量统计<?php if($act == 1 ): ?>(日统计)<?php else: ?>(月统计)<?php endif; ?>
              </h4>
            </div>
