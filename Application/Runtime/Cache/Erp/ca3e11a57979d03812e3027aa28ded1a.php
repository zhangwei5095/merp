            	...
            	<div class="controls">  
					 ...
					 <div class="form-group col-sm-12">
					    ...
					    <div class="col-sm-9">
					    	...
					    	<?php if($ac == 'add'): ?><input type="hidden" name="in_num_old" value="<?php echo ($Purchase['in_num']); ?>">
					    	<input type="hidden" name="id" value="<?php echo ($Purchase['id']); ?>">
					    	<small>原入库数量为：<?php echo ($Purchase['in_num']); ?>  &nbsp;&nbsp;(本次"入库数量"为在原基础上新增数量)</small><?php endif; ?>
					    </div>
					 </div>
 					 <div class="form-group col-sm-12">
					    <label class="col-sm-3 control-label text-right">
					 ...
					 <div class="form-group col-sm-12">
					    ...
					    <div class="col-sm-9">
					    	<input class="form-control" name="purchase" id="purchase" type="text" value="<?php echo (date('Y-m-d',NOW_TIME)); ?>" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" placeholder="入库时间">
					    </div>
					 </div>
					 <div class="form-group col-sm-12">
					    <label class="col-sm-3 control-label text-right">
					    ...
					    <div class="col-sm-9">
					    	<input class="form-control" name="dateymd" id="dateymd" type="text" value="<?php echo (date('Y-m-d',NOW_TIME)); ?>" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" placeholder="入库时间">
					    </div>
					 </div>
				</div>
            </div>
