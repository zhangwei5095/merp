...
<div class="container" id="container" style="width: 100%;">
	...
	<div class="row">
		...
		<div class="col-xs-6" style="text-align: right">
			<?php if($_SESSION['admin_gid'] == 1): ?><a href="<?php echo U('Sales/add');?>" class="btn btn-primary"  >新增</a><?php endif; ?>
			<a href="<?php echo U('Sales/index');?>" class="btn btn-default"  >刷新</a>
			<a href="<?php echo U('Sales/export');?>" class="btn btn-default"  >导出</a>
		</div>
	</div>
	<p></p>
	<div class="row">
        <div class="col-sm-12">
          <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <tbody>
	                <?php if(is_array($Order)): $k = 0; $__LIST__ = $Order;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$list): $mod = ($k % 2 );++$k;?><tr>
							<td><?php echo ($k); ?></td>
							<td><?php echo ($list["order_no"]); ?></td>
							<td><?php echo ($list["realname"]); ?></td>
							<td>
								<?php if($list['order_type'] == 1): ?>零售<?php endif; ?>
								<?php if($list['order_type'] == 2): ?>代理<?php endif; ?>
							</td>
							<td>
								<?php if($list['pay_type'] == 1): ?>银行转账<?php endif; ?>
								<?php if($list['pay_type'] == 2): ?>支付宝<?php endif; ?>
								<?php if($list['pay_type'] == 3): ?>微信支付<?php endif; ?>
								<?php if($list['pay_type'] == 4): ?>理财通支付<?php endif; ?>
								<?php if($list['pay_type'] == 5): ?>其他<?php endif; ?>
							</td>
							<td><?php echo ($list["num_total"]); ?></td>
							<td><?php echo ($list["amount_total"]); ?></td>
							<!-- <td><?php echo ($list["logistics_no"]); ?></td> -->
							<td><?php echo ($list["order_time"]); ?><!-- <?php echo (date('Y-m-d',$list["dateline"])); ?> --></td>
							<td>
								<div class="btn-group">
								<a class="btn btn-sm btn-default dropdown-toggle" data-toggle="dropdown" href="#" onclick="return false;">
									<?php if($list['order_status'] == 0): ?><span class ="red">已确认</span><?php endif; ?>
									<?php if($list['order_status'] == 1): ?><span class ="red">已付款</span><?php endif; ?>
									<?php if($list['order_status'] == 2): ?><span class ="red">已发货</span><?php endif; ?>
									<?php if($list['order_status'] == 3): ?><span class ="green">已完成</span><?php endif; ?>
									<?php if($list['order_status'] == 4): ?><span class ="yellow">退货中</span><?php endif; ?>
									<?php if($list['order_status'] == 5): ?><span class ="yellow">退货完成</span><?php endif; ?>
									<span class="caret"></span>
								</a>
								<?php if($_SESSION['admin_gid'] == 1): if($list['order_status'] != 5): ?><ul class="dropdown-menu pull-right">
										<?php if($list['order_status'] <= 0): ?><li><a href="<?php echo U('Sales/status',array('id'=>$list['order_id'],'order_status'=>1));?>">已付款</a> 
											</li><?php endif; ?>
										<?php if($list['order_status'] <= 1): ?><li><a href="<?php echo U('Sales/status',array('id'=>$list['order_id'],'order_status'=>2));?>">已发货</a> 
											</li><?php endif; ?>
										<?php if($list['order_status'] <= 2): ?><li><a href="<?php echo U('Sales/status',array('id'=>$list['order_id'],'order_status'=>3));?>">已完成</a> 
											</li><?php endif; ?>
										<?php if($list['order_status'] <= 3): ?><li><a href="<?php echo U('Sales/status',array('id'=>$list['order_id'],'order_status'=>4));?>">退货中</a> 
											</li><?php endif; ?>
										<?php if($list['order_status'] <= 4): ?><li><a href="<?php echo U('Sales/status',array('id'=>$list['order_id'],'order_status'=>5));?>">退货完成</a> 
											</li><?php endif; ?>
									</ul><?php endif; endif; ?>
							</div>
							</td>
							...
							<div class="btn-group">
								<a class="btn btn-sm btn-default dropdown-toggle" data-toggle="dropdown" href="#" onclick="return false;">
									<?php if($list['pay_status'] == 1): ?><span class ="red">未付款</span><?php endif; ?>
									<?php if($list['pay_status'] == 2): ?><span class ="red">部分付款</span><?php endif; ?>
									<?php if($list['pay_status'] == 3): ?><span class ="green">已付款</span><?php endif; ?>
									<?php if($list['pay_status'] == 4): ?><span class ="yellow">部分退款</span><?php endif; ?>
									<?php if($list['pay_status'] == 5): ?><span class ="yellow">完全退款</span><?php endif; ?>
									<span class="caret"></span>
								</a>
								<?php if($_SESSION['admin_gid'] == 1): if($list['pay_status'] != 5): ?><ul class="dropdown-menu pull-right">
										<?php if($list['pay_status'] < 1): ?><li><a href="<?php echo U('Sales/paystatus',array('id'=>$list['order_id'],'pay_status'=>1));?>">未付款</a> 
											</li><?php endif; ?>
										<?php if($list['pay_status'] < 2): ?><li><a href="<?php echo U('Sales/paystatus',array('id'=>$list['order_id'],'pay_status'=>2));?>">部分付款</a> 
											</li><?php endif; ?>
										<?php if($list['pay_status'] < 3): ?><li><a href="<?php echo U('Sales/paystatus',array('id'=>$list['order_id'],'pay_status'=>3));?>">已付款</a> 
											</li><?php endif; ?>
										<?php if($list['pay_status'] < 4): ?><li><a href="<?php echo U('Sales/paystatus',array('id'=>$list['order_id'],'pay_status'=>4));?>">部分退款</a> 
											</li><?php endif; ?>
										<?php if($list['pay_status'] < 5): ?><li><a href="<?php echo U('Sales/paystatus',array('id'=>$list['order_id'],'pay_status'=>5));?>">完全退款</a> 
											</li><?php endif; ?>
									</ul><?php endif; endif; ?>
							</div>
							</td>
							<td>
							<a href="<?php echo U('Sales/detail',array('id'=>$list['order_id']));?>" class="btn btn-sm btn-primary">查看</a>
							<?php if($_SESSION['admin_gid'] == 1): ?><a href="<?php echo U('Sales/edit',array('id'=>$list['order_id']));?>" class="btn btn-sm btn-primary">编辑</a>
							<a href="<?php echo U('Sales/refund',array('id'=>$list['order_id']));?>" class="btn btn-sm btn-warning">退货</a>
							<a href="<?php echo U('Sales/delete',array('order_id'=>$list['order_id']));?>" onclick="return(confirm('确认删除订单吗?'))" class="btn btn-sm btn-danger" title="订单删除后库存不会自动恢复" >删除</a><?php endif; ?>
							</td>
