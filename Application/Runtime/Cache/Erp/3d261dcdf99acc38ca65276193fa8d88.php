...
<form action="<?php echo U('Statistics/goods',array('op'=>$op));?>" name="form" method="post" >
					  ...
					  <div class="panel-body">
					    <div class="form-group col-sm-6">
					 	...
					 	<div class="form-group col-sm-12 text-center">
						 	<input type="button" class="btn btn-primary" onclick="_submit()" value="统计">
					 	</div>
