...
<script type="text/javascript" src="/merp/Public/assets/js/jquery.ztree.core-3.5.min.js"></script>
<script type="text/javascript" src="/merp/Public/assets/js/jquery.ztree.excheck-3.5.min.js"></script>
<link rel="stylesheet" href="/merp/Public/assets/css/zTreeStyle/zTreeStyle.css" type="text/css" media="screen" />
<script type="text/javascript">
...
<form action="<?php echo U('Goods/save');?>" name="form" method="post">
	<div class="row">
	...
	<div class="row">
		...
		<div class="col-xs-6" style="text-align: right">
			...
			<a href="<?php echo U('Goods/index');?>" class="btn btn-default"  >返回</a>
		</div>
	</div>
	<p></p>
	<div class="row">
