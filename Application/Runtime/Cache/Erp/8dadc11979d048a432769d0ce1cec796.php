...
<script type="text/javascript" src="/merp/Public/assets/js/jsAddress.js"></script>
<script type="text/javascript">
function validate(){
            ...
            <div class="panel-body">
            	<div class="controls">  
					 <div class="form-group col-sm-12">
					    ...
					    <div class="col-sm-9">
					    	<input class="form-control" name="realname" id="realname" type="text" placeholder="真实姓名">
					    </div>
					 </div>
					 <!-- <div class="form-group col-sm-12">
					    <label class="col-sm-3 control-label text-right">
					    ...
					    <div class="col-sm-9">
					    	<input class="form-control" name="membercardid" id="membercardid" type="text" placeholder="会员卡卡号">
					    </div>
					 </div> -->
					 <div class="form-group col-sm-12">
					    <label class="col-sm-3 control-label text-right">
					    ...
					    <div class="col-sm-9">
					    	<input class="form-control" name="wecha_account" id="wecha_account" type="text" placeholder="微信账号">
					    </div>
					 </div>
					 <div class="form-group col-sm-12">
					    <label class="col-sm-3 control-label text-right">
					    ...
					    <div class="col-sm-9">
					    	<input class="form-control" name="wecha_name" id="wecha_name" type="text" placeholder="微信名">
					    </div>
					 </div>
					 <div class="form-group col-sm-12">
					    <label class="col-sm-3 control-label text-right">
					    ...
					    <div class="col-sm-9">
					    	<input class="form-control" name="qq" id="qq" type="text" placeholder="QQ账号">
					    </div>
					 </div>
					 <div class="form-group col-sm-12">
					    <label class="col-sm-3 control-label text-right">
					 ...
					 <div class="form-group col-sm-12">
					    ...
					    <div class="col-sm-9">
					    	<input class="form-control" name="mobile" id="mobile" type="tel" placeholder="手机号">
					    </div>
					 </div>
					 <div class="form-group col-sm-12">
					    <label class="col-sm-3 control-label text-right">
					    ...
					    <div class="col-sm-9">
					    	<input class="form-control" name="phone" id="phone" type="tel" placeholder="座机">
					    </div>
					 </div>
					 <div class="form-group col-sm-12">
					    <label class="col-sm-3 control-label text-right">
					 ...
					 <div class="form-group col-sm-12">
					    ...
					    <div class="col-sm-9">
					    	<input class="form-control" name="credit" id="credit" type="text" placeholder="会员积分">
					    </div>
					 </div>
					 <div class="form-group col-sm-12">
					    <label class="col-sm-3 control-label text-right">
					    ...
					    <div class="col-sm-9">
					    	<input class="form-control" name="birthday" id="birthday" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" type="text" placeholder="生日">
					    </div>
					 </div>
					 <div class="form-group col-sm-12">
					    <label class="col-sm-3 control-label text-right">
					    ...
					    <div class="col-sm-9">
					    	<input class="form-control" name="cardid" id="cardid" type="text" placeholder="身份证号">
					    </div>
					 </div>
					 <div class="form-group col-sm-12">
					    <label class="col-sm-3 control-label text-right">
					 ...
					 <div class="form-group col-sm-12">
					    ...
					    <div class="col-sm-9">
					    	<input class="form-control" name="address" id="address" type="text" placeholder="详细地址">
					    </div>
					 </div>
					 <div class="form-group col-sm-12">
					    <label class="col-sm-3 control-label text-right">
					    ...
					    <div class="col-sm-9">
					    	<input class="form-control" name="zipcode" id="zipcode" type="text" placeholder="邮编">
					    </div>
					 </div>
					 ...
					 <div class="form-group col-sm-12">
					    ...
					    <div class="col-sm-9">
					    	<textarea class="form-control" name="Member_desc" id="Member_desc"  placeholder="会员简介"></textarea>
					    </div>
					 </div>
				</div>
            </div>
