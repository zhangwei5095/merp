        ...
        <div class="col-sm-12">
          <div class="panel panel-primary">
            <div class="panel-heading">
              <h4 class="panel-title">退货数量统计<?php if($act == 1 ): ?>(日统计)<?php else: ?>(月统计)<?php endif; ?>
              </h4>
            </div>
					    ...
					    <div class="form-group col-sm-6">
					 	...
					 	<div class="form-group col-sm-12">
						 	<ul id="myTab" class="nav nav-tabs">
							   <li class="active">
							      <a href="#statistics2" data-toggle="tab">折线图</a>
							   </li>
							   <li><a href="#statistics3" data-toggle="tab">柱状图</a></li>
							</ul>
