...
<input type="hidden" name="order_id" value="<?php echo ($Order['order_id']); ?>">
	<div class="row">
		...
		<h3>订单管理</h3>
	    <p>查看和管理商品订单 </p>
	    <p><?php if($act != 'detail' ): ?>修改订单<?php endif; if($act == 'detail' ): ?>查看订单<?php endif; ?> </p>
	  	</div>
	</div>
	<div class="row">
	 	<div class="col-xs-6">
        ...
        <div class="col-sm-12">
            ...
            <div class="panel-body">
            	<div class="controls">  
					 <div class="form-group col-sm-6">
					    ...
					    <div class="col-sm-9">
					    	<input class="form-control" name="order_no" id="order_no" type="text" value="<?php echo ($Order['order_no']); ?>" readonly="readonly" <?php if($act == 'detail' ): ?>disabled="disabled"<?php endif; ?>>
					    </div>
					 </div>
					 <div class="form-group col-sm-6">
					    <label class="col-sm-3 control-label text-right">
					    ...
					    <div class="col-sm-9">
					   	 	<select name="mid" class="form-control" <?php if($act == 'detail' ): ?>disabled="disabled"<?php endif; ?>>
					 ...
					 <div class="form-group col-sm-6">
					    ...
					    <div class="col-sm-9">
					    	<input class="form-control" name="order_time" id="order_time" type="text" value="<?php echo ($Order['order_time']); ?>" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" placeholder="下单时间" <?php if($act == 'detail' ): ?>disabled="disabled"<?php endif; ?>>
					    </div>
					 </div>
 					 <div class="form-group col-sm-6">
					    <label class="col-sm-3 control-label text-right">
					    ...
					    <div class="col-sm-9">
					    	<select name="order_type" class="form-control" <?php if($act == 'detail' ): ?>disabled="disabled"<?php endif; ?>>
 					 ...
 					 <div class="form-group col-sm-6">
					    ...
					    <div class="col-sm-9">
					    	<select name="order_status" class="form-control" <?php if($act == 'detail' ): ?>disabled="disabled"<?php endif; ?>>
					    		<option value="0" <?php if($Order['order_status'] == 1): ?>selected="selected"<?php endif; ?>>已确认</option>
								<option value="1" <?php if($Order['order_status'] == 2): ?>selected="selected"<?php endif; ?>>已付款</option>
								<option value="2" <?php if($Order['order_status'] == 3): ?>selected="selected"<?php endif; ?>>已发货</option>
								<option value="3" <?php if($Order['order_status'] == 4): ?>selected="selected"<?php endif; ?>>已完成</option>
								<option value="4" <?php if($Order['order_status'] == 5): ?>selected="selected"<?php endif; ?>>退货中</option>
								<option value="5" <?php if($Order['order_status'] == 6): ?>selected="selected"<?php endif; ?>>已退货</option>
					    	</select>
					    </div>
					 </div>
				</div>
          ...
          <div class="panel panel-primary">
            ...
            <div class="panel-body">
            	<div class="controls">  
					    ...
					    <div class="col-sm-9">
					    	<input class="form-control" name="num_total" id="num_total" type="text" value="<?php echo ($Order['num_total']); ?>" placeholder="出货数量" readonly="readonly" <?php if($act == 'detail' ): ?>disabled="disabled"<?php endif; ?>>
					    </div>
					 </div>
					 <div class="form-group col-sm-6">
					    <label class="col-sm-3 control-label text-right">
					    ...
					    <div class="col-sm-9">
					    	<input class="form-control" name="num_refund" id="num_refund" type="text" value="<?php echo ($Order['num_refund']); ?>" placeholder="退货数量" <?php if($act == 'detail' ): ?>disabled="disabled"<?php endif; ?>>
					    </div>
					 </div>
					...
					<div class="table-responsive">
		                ...
		                <?php if(is_array($OrderGoods)): $k = 0; $__LIST__ = $OrderGoods;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$list): $mod = ($k % 2 );++$k;?><tr id="tr<?php echo ($list['goods_id']); ?>">
								...
								<input id="stock_old<?php echo ($list['goods_id']); ?>" type="hidden" value="<?php echo ($list['stock_old']); ?>">
								</td>
								...
								<td><?php echo ($list['price'] * $list['num']); ?></td>
          ...
          <div class="panel panel-primary">
            <div class="panel-heading">
              ...
              <?php if($act != 'detail' ): ?><a href="#" onclick="resetLogistics('amount');return false;" style="float: right">清空</a><?php endif; ?>
              </h4>
            </div>
            <div class="panel-body">
            	<div class="controls">  
					 <div class="form-group col-sm-6">
					    ...
					    <div class="col-sm-9">
					    	<select name="pay_status" class="form-control" <?php if($act == 'detail' ): ?>disabled="disabled"<?php endif; ?>>
								<option value="1" <?php if($Order['pay_status'] == 1): ?>selected="selected"<?php endif; ?>>未付款</option>
								<option value="2" <?php if($Order['pay_status'] == 2): ?>selected="selected"<?php endif; ?>>部分付款</option>
								<option value="3" <?php if($Order['pay_status'] == 3): ?>selected="selected"<?php endif; ?>>已付款</option>
								<option value="4" <?php if($Order['pay_status'] == 4): ?>selected="selected"<?php endif; ?>>部分退款</option>
								<option value="5" <?php if($Order['pay_status'] == 5): ?>selected="selected"<?php endif; ?>>完全退款</option>
					    	</select>
					    </div>
					 </div>
 					 <div class="form-group col-sm-6">
					    ...
					    <div class="col-sm-9">
					    	<select name="pay_type" class="form-control" <?php if($act == 'detail' ): ?>disabled="disabled"<?php endif; ?>>
					 ...
					 <div class="form-group col-sm-6">
					    ...
					    <div class="col-sm-9">
					    	<input class="form-control amount" name="amount_freight" id="amount_freight" type="text" value="<?php echo ($Order['amount_freight']); ?>" placeholder="卖家承担运费为-10；买家承担运费为0" <?php if($act == 'detail' ): ?>disabled="disabled"<?php endif; ?>>
					    </div>
					 </div>
					 <div class="form-group col-sm-6">
					    <label class="col-sm-3 control-label text-right">
					    ...
					    <div class="col-sm-9">
					    	<input class="form-control amount" name="amount_total" id="amount_total" type="text" value="<?php echo ($Order['amount_total']); ?>" placeholder="商品金额" <?php if($act == 'detail' ): ?>disabled="disabled"<?php endif; ?>>
					    </div>
					 </div>
					 <div class="form-group col-sm-6">
					    <label class="col-sm-3 control-label text-right">
					    ...
					    <div class="col-sm-9">
					    	<input class="form-control amount" name="amount_payed" id="amount_payed" type="text" value="<?php echo ($Order['amount_payed']); ?>" placeholder="已支付额" <?php if($act == 'detail' ): ?>disabled="disabled"<?php endif; ?>>
					    </div>
					 </div>
					 <div class="form-group col-sm-6">
					    <label class="col-sm-3 control-label text-right">
					    ...
					    <div class="col-sm-9">
					    	<input class="form-control amount" name="amount_refund" id="amount_refund" type="text" value="<?php echo ($Order['amount_refund']); ?>" placeholder="已退款额" <?php if($act == 'detail' ): ?>disabled="disabled"<?php endif; ?>>
					    </div>
					 </div>
				</div>
            </div>
          ...
          <div class="panel panel-primary">
            <div class="panel-heading">
              ...
              <?php if($act != 'detail' ): ?><a href="#" onclick="resetLogistics('logistics');return false;" style="float: right" >清空</a><?php endif; ?>
              </h4>
            </div>
            <div class="panel-body">
            	<div class="controls">  
					 <div class="form-group col-sm-6">
					    ...
					    <div class="col-sm-9">
					    	<input class="form-control logistics" name="logistics_no" id="logistics_no" type="text" value="<?php echo ($Order['logistics_no']); ?>" placeholder="物流单号" <?php if($act == 'detail' ): ?>disabled="disabled"<?php endif; ?>>
					    </div>
					 </div>
					 <div class="form-group col-sm-6">
					    <label class="col-sm-3 control-label text-right">
					    ...
					    <div class="col-sm-9">
					    	<input class="form-control logistics" name="logistics_company" id="logistics_company" type="text" value="<?php echo ($Order['logistics_company']); ?>" placeholder="物流公司" <?php if($act == 'detail' ): ?>disabled="disabled"<?php endif; ?>>
					    </div>
					 </div>
					 <div class="form-group col-sm-6">
					    <label class="col-sm-3 control-label text-right">
					    ...
					    <div class="col-sm-9">
					    	<input class="form-control logistics" name="zipcode" id="zipcode" type="text" value="<?php echo ($Order['zipcode']); ?>" placeholder="邮编" <?php if($act == 'detail' ): ?>disabled="disabled"<?php endif; ?>>
					    </div>
					 </div>
					 <div class="form-group col-sm-6">
					    <label class="col-sm-3 control-label text-right">
					    ...
					    <div class="col-sm-9">
					    	<input class="form-control logistics" name="consignee" id="consignee" type="text" value="<?php echo ($Order['consignee']); ?>" placeholder="收货人" <?php if($act == 'detail' ): ?>disabled="disabled"<?php endif; ?>>
					    </div>
					 </div>
					 <div class="form-group col-sm-6">
					    <label class="col-sm-3 control-label text-right">
					    ...
					    <div class="col-sm-9">
					    	<input class="form-control logistics" name="consignee_phone" id="consignee_phone" type="text" value="<?php echo ($Order['consignee_phone']); ?>" placeholder="收货电话" <?php if($act == 'detail' ): ?>disabled="disabled"<?php endif; ?>>
					    </div>
					 </div>
					 <div class="form-group col-sm-6">
					    <label class="col-sm-3 control-label text-right">
					    ...
					    <div class="col-sm-9">
					    	<input class="form-control logistics" name="delivery_address" id="delivery_address" type="text" value="<?php echo ($Order['delivery_address']); ?>" placeholder="收货地址" <?php if($act == 'detail' ): ?>disabled="disabled"<?php endif; ?>>
					    </div>
					 </div>
					 <div class="form-group col-sm-6">
					    <label class="col-sm-3 control-label text-right">
					    ...
					    <div class="col-sm-9">
					    	<input class="form-control logistics" name="weight" id="weight" type="text" value="<?php echo ($Order['weight']); ?>" placeholder="物品重量" <?php if($act == 'detail' ): ?>disabled="disabled"<?php endif; ?>>
					    </div>
					 </div>
					 <div class="form-group col-sm-6">
					    <label class="col-sm-3 control-label text-right">
					    ...
					    <div class="col-sm-9">
					    	<input class="form-control logistics" name="num_delivered" id="num_delivered" type="text" value="<?php echo ($Order['num_delivered']); ?>" placeholder="已发货数量" <?php if($act == 'detail' ): ?>disabled="disabled"<?php endif; ?>>
					    </div>
					 </div>
				</div>
            </div>
